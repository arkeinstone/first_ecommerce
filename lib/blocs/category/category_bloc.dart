...
import 'package:first_ecommerce_app/repositories/category/category_repository.dart';
...
class CategoryBloc extends Bloc<CategoryEvent, CategoryState> {
  ...
  void _onLoadCategories(event, Emitter<CategoryState> emit){
    ...
    _categoryRepository.getAllCategories().listen((categories) => add(UpdateCategories(categories: categories)));
  }
